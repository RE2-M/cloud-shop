...
if Config.Framework ~= "rsgcore" then return end
...
local function CanCarryItem(source, itemName, itemQuantity)
	if Config.OxInventory then
		...
		return exports["rsg-inventory"]:CanAddItem(source, itemName, itemQuantity)
	end
end
...
local function AddItem(source, itemName, itemQuantity)
	if Config.OxInventory then
		...
		if isWeapon then return exports["rsg-inventory"]:AddItem(source, itemName, itemQuantity, false, { quality = 100 }, "cloud-shop:AddWeapon") end
		return exports["rsg-inventory"]:AddItem(source, itemName, itemQuantity, false, false, "cloud-shop:AddItem")
	end
end
